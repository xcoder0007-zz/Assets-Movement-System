			...
			<form action="" method="POST" id="form-submit" class="form-div span12" accept-charset="utf-8">
				...
				<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 rtl">
					...
					<div class="col-lg-6 col-md-8 col-sm-8 col-xs-8 rtl">
						<input type="text" class="form-control" name="time" id="time" readonly="readonly" value="<?php echo $project['timestamp']; ?>"  />
					</div>
				...
				<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 rtl">
					<label for="supplier[]" class="col-lg-3 col-md-4 col-sm-5 col-xs-5 control-label rtl">الشركات المرشحه للتنفيذ</label>
					<div class="col-lg-6 col-md-8 col-sm-8 col-xs-8 rtl">
						<select class="form-control chooosen" name="supplier[]" id="supplier" multiple="multiple" data-placeholder="Select Suppliers...">
							<?php foreach ($suppliers as $supplier): ?>
								<option value="<?php echo $supplier['id'] ?>" <?php echo (array_assoc_value_exists($selected_suppliers, 'id', $supplier['id']))? 'selected="selected"' : ''; ?>><?php echo $supplier['name'] ?></option>
							<?php endforeach ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
				    <div class="col-lg-offset-3 col-lg-10 col-md-10 col-md-offset-3">
				    	...
				    	<a href="/project_owning" class="btn btn-warning">Go Back</a>
				    </div>
				</div>
