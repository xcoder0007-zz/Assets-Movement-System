<?php
	...
	$this->set_js("assets/js/jquery.tablesorter.min.js");
	$this->set_js("assets/js/jquery.tablesorter.widgets.min.js");
	$this->set_js("assets/js/jquery.tablesorter.pager.min.js");
