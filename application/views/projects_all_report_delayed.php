...
<div id="wrapper">
	...
	<div class="container">
		...
		<div class="rest-selector col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<fieldset>
			<legend class="title-table">Project Delayed Report</legend>
			<?php if ($no_hotels): ?>
			<?php $this->load->view('report_form_simple_hotel'); ?>
			<?php else: ?>
				<?php $this->load->view('report_form_simple_all_hotels'); ?>
			<?php endif ?>		
			...
			<?php foreach ($projects as $project): ?>
				<tr>
					...
					<td style="text-align: center;">
						<?php echo $project['progress_name'] ?>
					</td>
