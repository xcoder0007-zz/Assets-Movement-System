...
<div id="wrapper">
	...
	<div class="container">
		...
		<div class="rest-selector col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<?php else: ?>
				<?php $this->load->view('report_form_progress_month'); ?>
			<?php endif ?>		
		...
		<?php if (isset($posting)): ?>
			...
			<?php foreach ($projects as $project): ?>
				<tr>
					...
					<td>
						<?php if ($project['progress_name'] == 'Done'): ?><div class="lower" style="background-color:#5cb85c;color:#fff"><?php echo $project['progress_name'] ?></div><span><?php echo $project['done_date'] ?></span>
		            ...
		            <?php foreach ($project['approvals'] as $approval): ?>
		              ...
		              <?php elseif(isset($approval['queue'])): ?>
		                <div><?php echo $approval['role'] ?></div>
		              <?php endif ?>
		            <?php endforeach ?>
		          </td>
