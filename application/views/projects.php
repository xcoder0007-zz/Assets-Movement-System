...
<div id="wrapper">
  ...
  <div id="page-wrapper">
  <?php if ($isGM || $isDptHead): ?>
    <a href="/projects/prepare" class="btn btn-success">New Project (planned)</a><br /><br />
  <?php endif ?>
  <?php if ($isGM): ?>
    <a href="/requests/request" class="btn btn-info">Request Unplanned Project Approval</a>
  <?php endif; ?>
  <br>
    ...
    <table class="table table-bordered table-hover table-striped tablesorter">
      <thead>
        <tr>
          ...
          <th class="header">Final Cost <i class="fa fa-sort"></i></th>
      ...
      <?php foreach ($projects as $project): ?>
        <tr class="active">
          ...
          <td><?php echo $project['origin_name'] ?><br /><?php echo $project['type_name'] ?></td>
          <td><?php echo number_format($project['cost'],2,".",","); ?> LE</td>
          <td>
          ...
          <td>
            ...
            <?php if ($project['hotel_id'] == 5): ?>
              <a href="<?php echo base_url(); ?>project_owning/review/<?php echo $project['id'] ?>" class="btn btn-warning">Review</a>
            <?php endif ?>
          </td>
        </tr>
      <?php endforeach; ?>
