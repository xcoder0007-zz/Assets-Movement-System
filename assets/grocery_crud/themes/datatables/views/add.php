<?php
	...
	$this->set_css($this->default_theme_path.'/datatables/css_header/bootstrap.min.css');
	$this->set_css($this->default_theme_path.'/datatables/css_header/bootstrap-responsive.min.css');
	$this->set_css($this->default_theme_path.'/datatables/css_header/style.css');
	...
	$this->set_js($this->default_theme_path.'/datatables/js_header/libs/bootstrap/bootstrap.min.js');
