  ...
  <body>
    <div id="wrapper">
      <?php $this->load->view('menu'); ?>
        <div id="page-wrapper">
          <a href="<?php echo base_url(); ?>amenity/add/" class="btn btn-info">New Guest Amenity Request</a>
        ...
        <table class="table table-bordered table-hover table-striped tablesorter">
          ...
          <tbody>
            ...
            <tr class="active">
              ...
              <td><?php echo $forma['treatment'] ?></td>
              <td><?php echo $forma['room'] ?></td>
              <td><a href="<?php echo base_url(); ?>amenity/view/<?php echo $forma['id'] ?> " class="btn btn-primary">View</a></td>
              <td>
