...
class CI_Email {
	...
	var	$smtp_host		= "mail.sunrise-resorts.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "e-signature@sunrise-resorts.com";		// SMTP Username
	var	$smtp_pass		= "Abc$123";		// SMTP Password
