	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
				<select class="form-control" name="state" id="state">
					...
					<option <?php echo set_select('state', 1); ?> value="1">In-Progress</option>
					<option <?php echo set_select('state', 2); ?> value="2">Holding</option>
					<option <?php echo set_select('state', 3); ?> value="3">Done</option>
					<option <?php echo set_select('state', 5); ?> value="5">Delayed</option>
					<option <?php echo set_select('state', 6); ?> value="6">Postponed</option>
					<option <?php echo set_select('state', 4); ?> value="4">Cancel</option>
				</select>
			</div>
	</div>
	<br />
