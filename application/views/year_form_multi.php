<form action="" method="POST" id="form-submit" class="form-div span12 noprint" accept-charset="utf-8" enctype="multipart/form-data">
	<div class="dates form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-8">
			<label for="years[]" class="date-lbl col-lg-3 col-md-3 col-sm-3 col-xs-3  control-label">Years</label>
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
				<select class="form-control chooosen" name="years[]" id="years[]" multiple="multiple" data-placeholder="Select Years..">
