    ...
    <table class="table table-bordered table-hover table-striped tablesorter">
      <thead>
        <tr>
          ...
          <th class="header">Original Approvals <i class="fa fa-sort"></i></th>
          <th class="header">Company Approvals <i class="fa fa-sort"></i></th>
      ...
      <?php foreach ($projects as $project): ?>
        <tr class="active">
          ...
          <td><?php echo number_format($project['budget'],2,".",","); ?> LE</td>
          <td>
          ...
          <td>
            <?php foreach ($project['signatures'] as $approval): ?>
              <?php if (isset($approval['sign'])): ?>
                <div class="signer<?php echo isset($approval['sign']['reject'])? ' rejected' : ' accepted' ?>"><?php echo $approval['sign']['name'] ?></div>
              <?php elseif(isset($approval['queue'])): ?>
                <div class="signer unsigned"><?php echo $approval['role'] ?></div>
          ...
          <td>
            <a href="<?php echo base_url(); ?>madar/view/<?php echo $project['id'] ?>" class="btn btn-primary">View</a>
            <a href="<?php echo base_url(); ?>madar_owning/review/<?php echo $project['id'] ?>" class="btn btn-warning">Review</a>
          </td>
